...
initStatTo = function(){
	...
	'resist-burn':{
		'icon':'offensive.burn',
		'name':'Burn Resist',
		'boost':{'stat':['resist','burn'],},
		},	
	'resistMax-burn':{
		'icon':'offensive.burn',
		'name':'Burn Max Resist',
		'boost':{'base':0.75,'stat':['resistMax','burn'],},
		'playerOnly':1,
		},
	'resist-chill':{
		'icon':'offensive.chill',
		'name':'Chill Resist',
		'boost':{'stat':['resist','chill'],},
		},	
	'resistMax-chill':{
		'icon':'offensive.chill',
		'name':'Chill Max Resist',
		'boost':{'base':0.75,'stat':['resistMax','chill'],},
		'playerOnly':1,
		},
	'resist-drain':{
		'icon':'offensive.drain',
		'name':'Chill Resist',
		'boost':{'stat':['resist','drain'],},
		},	
	'resistMax-drain':{
		'icon':'offensive.drain',
		'name':'Chill Max Resist',
		'boost':{'base':0.25,'stat':['resistMax','drain'],},
		'playerOnly':1,
		},
	'resist-confuse':{
		'icon':'offensive.confuse',
		'name':'Confuse Resist',
		'boost':{'stat':['resist','confuse'],},
		},	
	'resistMax-confuse':{
		'icon':'offensive.confuse',
		'name':'Confuse Max Resist',
		'boost':{'base':0.75,'stat':['resistMax','confuse'],},
		'playerOnly':1,
		},
	'resist-knock':{
		'icon':'offensive.knock',
		'name':'Knock Resist',
		'boost':{'stat':['resist','knock'],},
		},	
	'resistMax-knock':{
		'icon':'offensive.knock',
		'name':'Knock Max Resist',
		'boost':{'base':0.25,'stat':['resistMax','knock'],},
		'playerOnly':1,
		},	
	'resist-bleed':{
		'icon':'offensive.bleed',
		'name':'Bleed Resist',
		'boost':{'stat':['resist','bleed'],},
		},	
	'resistMax-bleed':{
		'icon':'offensive.bleed',
		'name':'Bleed Max Resist',
		'boost':{'base':0.25,'stat':['resistMax','bleed'],},
		'playerOnly':1,
		},
	//}	
	...
	'def-melee-mod':{
		'icon':'defensive.melee',
		'name':'Def Melee Mod',
		'boost':{'stat':['mastery','def','melee','mod'],},
		},		
	'def-range-+':{
		'icon':'defensive.range',
		'name':'Def Range +',
	...
	'def-magic-mod':{
		'icon':'defensive.magic',
		'name':'Def Magic x',
		'boost':{'stat':['mastery','def','magic','mod'],},
		},	
	'def-fire-+':{
		'icon':'defensive.fire',
		'name':'Def Fire +',
	...
	'def-fire-mod':{
		'icon':'defensive.fire',
		'name':'Def Fire Mod',
		'boost':{'stat':['mastery','def','fire','mod'],},
		},		
	'def-cold-+':{
		'icon':'defensive.cold',
		'name':'Def Cold +',
	...
	'def-cold-mod':{
		'icon':'defensive.cold',
		'name':'Def Cold Mod',
		'boost':{'stat':['mastery','def','cold','mod'],},
		},		
	'def-lightning-+':{
	...
	'def-lightning-mod':{
		...
		'boost':{'stat':['mastery','def','lightning','mod'],},
		},		
	//}
