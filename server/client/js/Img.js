...
Img.frame = {};
Img.frame.window = Tk.newImage('img/ui/interface/window.png');
Img.frame.postit = Tk.newImage('img/ui/interface/postit.png');
Img.help = {};
Img.help.uihelper = Tk.newImage('img/ui/interface/uihelper.png');
Img.help.arrow = {
	right:Tk.newImage('img/ui/interface/arrow-right.png'),
	left:Tk.newImage('img/ui/interface/arrow-left.png'),
	down:Tk.newImage('img/ui/interface/arrow-down.png'),
	up:Tk.newImage('img/ui/interface/arrow-up.png'),
}
...
(function(){
	for(var i = 0; i<= 9; i++) Img.icon.push(Tk.newImage("img/ui/icon/iconSheet" + i + ".png"));
	Img.icon.row = 5;
	...
	'color':{'y':system+1,'x':['red','yellow','cyan','green','purple','orange','magenta']},
	'system1':{'y':system+2,'x':['left','right','down','up','more','less']},
	'tab':{'y':system+3,'x':['equip','inventory','quest','skill','friend','pref']},
	'element':{'y':system+4,'x':['melee','range','magic','fire','cold','lightning','melee2','range2','magic2','fire2','cold2','lightning2']},
	...
	//Equip
	'weapon':{'y':equip+0,'x':['mace','spear','sword','bow','boomerang','crossbow','wand','staff','orb']},
	'amulet':{'y':equip+1,'x':['ruby','sapphire','topaz']},
	'helm':{'y':equip+2,'x':['metal','wood','bone']},
	'ring':{'y':equip+3,'x':['ruby','sapphire','topaz']},
	'body':{'y':equip+4,'x':['metal','wood','bone']},
	
	//Craft
	'plan':{'y':craft+0,'x':['equip','ability']},
	'shard':{'y':craft+1,'x':['white','blue','yellow','gold']},
	'orb':{'y':craft+2,'x':['upgrade','boost','removal','water','ruby','sapphire','topaz']},
...
//Npc Face Sheet
Img.face = Tk.newImage("img/ui/face/faceSheet.png");
