...
var	startExp = skillList[1];
var	endExp = skillList[99];


var youtubeDiv = document.getElementById('youtubeDiv');
var wantedHeaderDiv = document.getElementById('wantedHeaderDiv');
var incomePhInput = document.getElementById('incomePhInput');
var divTable = document.getElementById('divTable');
var divTable99 = document.getElementById('divTable99');
var mainDiv99 = document.getElementById('mainDiv99');
var boostDiv = document.getElementById('boostDiv');
var methodBox = document.getElementById('methodBox');
var startExpInput = document.getElementById('startExpInput');
var endExpInput = document.getElementById('endExpInput');
var visibleInput = document.getElementById('visibleInput');
var skillInput = document.getElementById('skillInput');
var speedInput = document.getElementById('speedInput');
var bonusExpInput = document.getElementById('bonusExpInput');



var ICON = 24;
var COINS = ' <img src="http://images3.wikia.nocookie.net/__cb20120509113360/runescape/images/3/30/Coins_10000.png" alt="" height=' + ICON + ' width=' + ICON + '></img>  ';
var COIN = ' <img src="http://images4.wikia.nocookie.net/__cb20110806164215/runescape/images/b/b6/Coins_100.png" alt="" height=' + ICON + ' width=' + ICON + '></img>  ';
var QUEST = ' <img src="http://images2.wikia.nocookie.net/__cb20120131231040/runescape/images/0/05/Quest_icon.png" alt="" height=' + ICON + ' width=' + ICON + '></img>  ';

var sortSign = 1;
var sortBy = 'Level';
var headerWanted = [];
var headerWanted99 = [];
var minimizeTable = false;
...
var headerList = {
	...
	'Output':0,
	//'Gp/1M Exp':0,
	'Time For Gp/1M Exp':0,
	'Time For Exp/1M Exp':0,
	'Time/1M Exp':1,
};
